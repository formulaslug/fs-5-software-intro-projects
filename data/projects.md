**Intro** 
Using a parquet file provided, you must either derive or graph what is asked of you. All the necessary information is provided in the parquet file. This project is a step by step idea of how a data project would work. Submit your work on a PDF. If you are stuck on a step, please write down your approach and where you got stuck.
...
2. a) Using matplotlib, graph the speed vs time. Refer to this document to know which column means what.
2. b) Find the speed of the car at 10s
